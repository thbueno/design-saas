      ...
      <div className="container">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-3">
          ...
          <FeatureCard
            ...
            description="sua marca no centro das atenções com uma id exclusiva, instantaneamente reconhecível e consistentemente cativante em todas as plataformas digitais."
            className="col-span-2 lg:col-span-1 group"
          >
            <div className="aspect-video flex items-center justify-center">
